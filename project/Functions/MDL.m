%   MDL() computes the Minimum Description Length (MDL) criterion for model order evaluation
%   Inputs:
...
%   Output:
%     MDL   - The value of the MDL function
%
%   Returns the MDL value for the given model ('ARX' or 'FIR') based on input
%   samples u, output samples y, and the estimated parameters vector theta

function MDL = MDL(u, y, theta, model)
    switch model
        case 'ARX'
            ...
            % Compute the MDL value
            MDL = N * log(J_theta) + p * log(N);
